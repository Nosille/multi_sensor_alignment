...
The node also provides a few additional services as shown below:
	...
	revert		Resets buffers and reverts the initial guess used for the next registration to the current value in a companion alignment_publisher.
	reset		Resets alignment publisher to the pose in place when this node was launched.
