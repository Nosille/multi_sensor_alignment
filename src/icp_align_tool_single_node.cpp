...
int main(int argc, char **argv)
{
  ...
  std::string node_name = "icp_align_tool_single_node";
  ros::init(argc, argv, node_name);
  ros::NodeHandle nh("");
  ros::NodeHandle nh_private("~");
  
  ROS_INFO_STREAM_NAMED(node_name, "icp_align_tool single node starting.");
  ...
  Multi_Sensor_Alignment::Cloud_Alignment_Single node(nh, nh_private, buffer_size);
