...
int main(int argc, char **argv)
{
  ...
  std::string node_name = "iimu_tare_tool_node";
  ros::init(argc, argv, node_name);
  ros::NodeHandle nh("");
  ros::NodeHandle nh_private("~");
  
  ROS_INFO_STREAM_NAMED(node_name, "imu_tare_tool node starting.");
  ...
  Multi_Sensor_Alignment::IMU_Tare node(nh, nh_private, buffer_size);
